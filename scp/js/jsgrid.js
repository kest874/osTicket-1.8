...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        cellClass: "jsgrid-cell notranslate",
        ...
        pageSize: 20,
        pageButtonCount: 5,
        pagerFormat: " {pages}",// &nbsp;&nbsp; showing {pageIndex} of {pageCount}",
        pagePrevText: "Prev",
        pageNextText: "Next",
        pageFirstText: "First",
        pageLastText: "Last",
        ...
        _createPager: function() {
            ...
            if($.isFunction(this.pagerRenderer)) {
                ...
                $result = $("<br><ul class='pagination'>").append(this._createPagerByFormat());
            }
        ...
        _createPages: function() {
            ...
            for(var i = 0, pageNumber = firstDisplayingPage; i < pageButtonCount && pageNumber <= pageCount; i++, pageNumber++) {
                pages.push(pageNumber === this.pageIndex
                    ? this._createPagerPage(pageNumber,'active')
        ...
        _createPagerPageNavButton: function(text, handler) {
            return this._createPagerButton(text, "", handler);
        },

        _createPagerPage: function(pageIndex,active) {
            return this._createPagerButton(pageIndex,active, function() {
                this.openPage(pageIndex);
            });
        },

        _createPagerButton: function(text, active, handler) {
            var $link = $("<a class='page-link'>").attr("href", EMPTY_HREF)
                .html(text)
                .on("click", $.proxy(handler, this));

            return $("<li class='page-item'>").addClass(active).append($link);
        },
...
(function(jsGrid, $, undefined) {
    ...
    TextField.prototype = new Field({
        ...
        insertTemplate: function() {
            ...
            return this.insertControl = this._createInsertTextBox();
        },
        ...
        _createTextBox: function() {
            return $("<input class='form-control form-control-sm'>").attr("type", "text")
                .prop("readonly", !!this.readOnly);
        },

        _createInsertTextBox: function() {
            return $("<input class='form-control form-control-sm requiredfield'>").attr("type", "text")
                .prop("readonly", !!this.readOnly);
        }
...
(function(jsGrid, $, undefined) {
    ...
    NumberField.prototype = new TextField({
        ...
        _createTextBox: function() {
			return $("<input class='form-control form-control-sm'>").attr("type", "number1")
                .prop("readonly", !!this.readOnly);
        },
		 _createInsertTextBox: function() {
			return $("<input class='form-control form-control-sm requiredfield'>").attr("type", "numbe1r")
                .prop("readonly", !!this.readOnly);
        }
    });
...
(function(jsGrid, $, undefined) {
    ...
    SelectField.prototype = new NumberField({
        ...
        insertTemplate: function() {
            ...
            return this.insertControl = this._createInsertSelect();
        },
		...
		_createInsertSelect: function() {
            var $result = $("<select class='form-control form-control-sm requiredfield'>"),
                valueField = this.valueField,
                textField = this.textField,
                selectedIndex = this.selectedIndex;
...
(function(jsGrid, $, undefined) {
    ...
    ControlField.prototype = new Field({
        ...
        searchModeButtonClass: "fa-search ",
        insertModeButtonClass: "fa-pencil-square",
		...
		modeOnButtonIcon: "<i class='fa fa-pencil-square btn-sm btn-icon waves-effect waves-light btn-warning' aria-hidden='true'  data-placement='bottom' data-toggle='tooltip'> </i>",
        searchModeButtonIcon: "<i class='fa fa-search btn-sm btn-icon waves-effect waves-light btn-warning' aria-hidden='true'  data-placement='bottom' data-toggle='tooltip'> </i>",
        insertModeButtonIcon: "<i class='fa fa-pencil-square btn-sm btn-icon waves-effect waves-light btn-warning' aria-hidden='true'  data-placement='bottom' data-toggle='tooltip'> </i>",
		editButtonIcon: "<i class='fa fa-pencil-square-o btn-sm btn-icon waves-effect waves-light btn-success leftbtn' aria-hidden='true'  data-placement='bottom' data-toggle='tooltip'> </i>",
        deleteButtonIcon: "<i class='fa fa-trash btn-sm btn-icon waves-effect waves-light btn-danger rightbtn' aria-hidden='true'  data-placement='bottom' data-toggle='tooltip'></i>",
        searchButtonIcon: "<i class='fa fa-search btn-sm btn-icon waves-effect waves-light  btn-primary leftbtn' aria-hidden='true'  data-placement='bottom' data-toggle='tooltip'></i>",
		clearFilterButtonIcon: "<i class='fa fa-filter btn-sm btn-icon waves-effect waves-light btn-primary rightbtn' aria-hidden='true' data-placement='bottom' data-toggle='tooltip'><i class='fa fa-ban filtercancel'></i>",
        insertButtonIcon: "<i class='fa fa-plus-square btn-sm btn-icon waves-effect waves-light btn-success' aria-hidden='true'  data-placement='bottom' data-toggle='tooltip'></i>",
        updateButtonIcon: "<i class='fa fa-save btn-sm btn-icon waves-effect waves-light btn-warning leftbtn' aria-hidden='true'  data-placement='bottom' data-toggle='tooltip'></i>",
        cancelEditButtonIcon: "<i class='fa fa-times  btn-sm btn-icon waves-effect waves-light btn-danger rightbtn' aria-hidden='true'  data-placement='bottom' data-toggle='tooltip'></i>",
        ...
        _createEditButton: function(item) {
            return this._createRowGridButton(this.editButtonIcon, this.editButtonTooltip, function(grid, e) {
                grid.editItem(item);
                e.stopPropagation();
            });
        },
        ...
        _createDeleteButton: function(item) {
            return this._createRowGridButton(this.deleteButtonIcon, this.deleteButtonTooltip, function(grid, e) {
        ...
        _createSearchButton: function() {
            return this._createRowGridButton(this.searchButtonIcon, this.searchButtonTooltip, function(grid) {
                grid.search();
            });
        },

        _createClearFilterButton: function() {
            return this._createRowGridButton(this.clearFilterButtonIcon, this.clearFilterButtonTooltip, function(grid) {
                grid.clearFilter();
            });
        },

        _createInsertButton: function() {
            return this._createRowGridButton(this.insertButtonIcon, this.insertButtonTooltip, function(grid) {
        ...
        _createUpdateButton: function() {
            return this._createRowGridButton(this.updateButtonIcon, this.updateButtonTooltip, function(grid, e) {
                grid.updateItem();
                e.stopPropagation();
            });
        },
        ...
        _createCancelEditButton: function() {
            return this._createRowGridButton(this.cancelEditButtonIcon, this.cancelEditButtonTooltip, function(grid, e) {
                grid.cancelEdit();
                e.stopPropagation();
            });
        },
        ...
        _createGridButton: function(cls, tooltip, clickHandler) {
            ...
            return $("<input class='hidden bg-white'><i class=' btn-sm btn-icon waves-effect waves-light btn-dark fa ' aria-hidden='true' data-placement='bottom' data-toggle='tooltip'> </i>").addClass(this.buttonClass)
               .addClass(cls)
                .attr({
		        ...
		        _createRowGridButton: function(icon, tooltip, clickHandler) {
            var grid = this._grid;
