...
<table class="tg" width="100%">
    ...
    <tr class="tg-3we0">
        <td width="220px">
            <strong>
                <a data-fancybox data-src="https://crpsql01/ReportServer/Pages/ReportViewer.aspx?%2fosTicket%2fSuggestions%2fSuggestions_AssociateSummary&rs:Command=Render">
    ...
    <tr class="tg-3we0">
        <td width="220px">
            <strong>
            <a data-fancybox data-src="https://crpsql01/ReportServer/Pages/ReportViewer.aspx?%2fosTicket%2fSuggestions%2fSuggestion+Summary&rs:Command=Render" target="_blank">
    ...
    <tr class="tg-3we0">
        <td width="220px">
            <strong>
                <a data-fancybox data-src="https://crpsql01/ReportServer/Pages/ReportViewer.aspx?%2fosTicket%2fSuggestions%2fSuggestions_OpenSuggesitonAge&rs:Command=Render" target="_blank">
        ...
        <td width="220px">
            <strong>
                <a data-fancybox data-src="https://crpsql01/ReportServer/Pages/ReportViewer.aspx?%2fosTicket%2fSuggestions%2fSuggestions_Suggesitons&rs:Command=Render" target="_blank">
                Suggestions</a>
            </strong>
        </td>
        <td>
