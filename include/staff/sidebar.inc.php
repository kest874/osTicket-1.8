...
if(!defined('ADMINPAGE')) { ?>
	...
	<li  class="has_sub">
		<a class="waves-effect waves-primary" href="/scp/tickets.php?queue=1&p=1&l=<?php echo Dept::getParentId($thisstaff->dept_id);?>&t=<?php echo $thisstaff->dept_id ?>&s=0"><i class=" ti-light-bulb"></i> </span> Suggestions</a> 
