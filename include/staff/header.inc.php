...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>scp/css/jquery.fancybox.min.css"/>
    <?php
                    ...
                    <ul class="list-inline float-right mb-0 mr-0">
                        ...
                        <li class="list-inline-item dropdown notification-list mr-0">
                            <a class="nav-link dropdown-toggle arrow-none waves-light waves-effect" data-toggle="dropdown" href="#" role="button"
                               aria-haspopup="false" aria-expanded="false" title="<?php echo __('My Teams Suggestions'); ?>">
                                <i class="mdi mdi-ticket noti-icon"></i>
                                <span class="badge badge-warning noti-icon-badge"><?php echo $AssignedSuggestions; ?></span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg" aria-labelledby="Preview">
                                <!-- item-->
                                <div class="dropdown-item noti-title">
                                    <h5 class="font-16"><span class="badge badge-warning float-right"><?php echo $AssignedSuggestions; ?></span>My Teams Suggestions</h5>
                                </div>

                                
                                <!-- item-->
                                <a href="/scp/tickets.php?queue=88&p=1&l=0&s=1" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-primary"><?php echo $AssignedSubmittedSuggestions ; ?></div>
                                    <p class="notify-details">Submitted<small class="text-muted">Submitted</small></p>
                                </a>
                                <!-- item-->
                                <a href="/scp/tickets.php?queue=88&p=1&l=0&s=8" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-danger"><?php echo $AssignedActiveSuggestions; ?></div>
                                    <p class="notify-details">Active<small class="text-muted">Suggestions being worked on</small></p>
                                </a>                                <!-- item-->
                                <a href="/scp/tickets.php?queue=88&p=1&l=0&s=7" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-success"><?php echo  $AssignedParkedSuggestions; ?></div>
                                    <p class="notify-details">Parking Lot<small class="text-muted">Suggestions on hold</small></p>
                                </a>
                                
                                <!-- All-->
                                <a href="tickets.php?queue=88&p=1&l=0&t=0&s=0" class="dropdown-item notify-item notify-all">
                                    View All
                                </a>
